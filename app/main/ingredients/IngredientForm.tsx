  ...
  return (
    ...
    >
      ...
      <TextInput
        ...
        className="border outline-none border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2 mb-3 text-black dark:text-white bg-white dark:bg-gray-800"
      />
      ...
      <View className="flex-row gap-2 mt-4">
        <TouchableOpacity
          onPress={onSubmit}
          className={`flex-1 py-3 rounded-lg ${isEditing ? 'bg-yellow-500' : 'bg-primary'}`}
        >
